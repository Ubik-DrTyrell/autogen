import unittest
from PandorasKey import PandorasLock

class TestPandorasLock(unittest.TestCase):
    def setUp(self):
        self.pandoras_lock = PandorasLock(config_path=setup_valid_config)
    ...
    def test_rdsID(self):
        self.generic_sanitization("The RDS arn:aws:rds:region:123456789012:db:R3d91llsDB is down", "The RDS arn:aws:rds:region:arnAccountNum:db:rdsId is down")
